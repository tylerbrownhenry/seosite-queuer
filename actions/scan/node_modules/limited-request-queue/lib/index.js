...
/* 
Get page html, gather links, add to queue
*/
...
function startNext(instance){
	var availableSockets = instance.options.maxSockets - instance.activeSockets; /* Unlimited by Default */
	var i = 0;
	...
	while (i < instance.priorityQueue.length){
		...
		if (instance.options.maxSocketsPerHost > 0){
			if (instance.activeHosts[currItem.hostKey] === undefined){
				...
				canStart = true;
			} else if (instance.activeHosts[currItem.hostKey] < instance.options.maxSocketsPerHost){ /* - < 1 ? */
