...
urllib = require("url"),
urlobj = require("urlobj"),
hasOwnProperty = Object.prototype.hasOwnProperty;

function linkObj(url){
	if (typeof url === "undefined" || isString(url) === false){
		url = null;
	}
	var link = {
		url:{
...
linkObj.resolve = function(link, base, options){
	...
	if (resolvedBase_parsed.href !== ""){
		link.base.resolved = parity(resolvedBase_parsed.href); // TODO :: use url types (>UNKNOWN && !=EMPTY ... not simple enough)
	}
	...
	link.resolved = true; // Avoid future resolving
	return link;
};
